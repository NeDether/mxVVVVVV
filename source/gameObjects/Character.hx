...
class Character extends FNFSprite
{
	...
	public var stopAnim:Bool = false;
	...
	public function setCharacter(x:Float, y:Float, character:String)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-wall-small':
				...
				flipX = true;
			case 'bf-wall-fire':
				frames = Paths.getSparrowAtlas('characters/bf-wall-fire');
				animation.addByPrefix('idle', 'idle', 40, false);
				animation.addByPrefix('singUP', 'up0', 40, false);
				animation.addByPrefix('singLEFT', 'left0', 40, false);
				animation.addByPrefix('singRIGHT', 'right0', 40, false);
			...
			case 'bf-flipped':
				...
				animation.addByPrefix('idle', 'idle', 12, false);
				animation.addByPrefix('singUP', 'up0', 12, false);
				animation.addByPrefix('singLEFT', 'right0', 12, false);
				animation.addByPrefix('singRIGHT', 'left0', 12, false);
				animation.addByPrefix('singDOWN', 'down0', 12, false);
				animation.addByPrefix('singUPmiss', 'up0', 12, false);
				animation.addByPrefix('singLEFTmiss', 'right0', 12, false);
				animation.addByPrefix('singRIGHTmiss', 'left0', 12, false);
				animation.addByPrefix('singDOWNmiss', 'down0', 12, false);
			...
			case 'luigi':
				...
				antialiasing = false;
			case 'mariofake':
				frames = Paths.getSparrowAtlas('characters/mariofake');
				...
				animation.addByPrefix('transition', 'transition', 30, false);
				...
				antialiasing = false;
			case 'marionear':
				frames = Paths.getSparrowAtlas('characters/marionear');
				animation.addByPrefix('idle', 'idle', 30, true);
				animation.addByPrefix('singUP', 'up', 30, false);
				animation.addByPrefix('singLEFT', 'left', 30, false);
				animation.addByPrefix('singRIGHT', 'right', 30, false);
				...
				antialiasing = false;
			case 'mx':
				frames = Paths.getSparrowAtlas('characters/mx');
		...
		{
			if (!curCharacter.startsWith('bf-flipped'))
			flipX = !flipX;
	...
	public function dance(?forced:Bool = false)
	{
		if (!debugMode)
		{
			var frame:Int = 0;
			var curCharSimplified:String = simplifyCharacter();
			if (curCharSimplified == 'mx' || curCharacter == 'mx-angry')
			...
			switch (curCharSimplified)
			{
				default:
					...
					// Play normal idle animations for all other characters
						...
						{
							if (!isJumping)
								playAnim('idle', forced, false, frame);
							else
								playAnim('jump', forced, false, frame);
						}
			}
		}
	}
